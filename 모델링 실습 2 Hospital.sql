...
insert into `Doctors` values ('D102104', '이사부','1966-09-12', 'M', '102','전문의','010-2104-1966','leesaby=u@bw.com');
...
insert into `Patients` values ('P102102', 'D102104','N102103','전지현','890530-1234567','M','대전','010-1103-8905','jjh@naver.com','자영업');
insert into `Patients` values ('P104101', 'D104101','N104101','이나영','790413-1234567','M','대전','010-2101-7904','lee@naver.com','회사원');
...
insert into `Patients` values ('P104102', 'D104101','N104101','고소영','840615-1234567','M','대구','010-4101-8406','goso@daum.net','회사원');
insert into `Patients` values ('P108101', 'D108101','N108101','김연아','651021-1234567','M','대구','010-5101-6510','yuna@daum.net','운동선수');
...
#문제 5
select chart_id, pat_name, doc_name, treat_contents, chart_contents, treat_datetime
from Charts a 
join Patients b
...
where dep_name like '%외과%';

#문제 6 - 화상으로 진료한 내역 가운데 진료번호, 환자이름, 담당의사명, 진료내용, 처방내용, 진료날짜 조회
select chart_id, pat_name, doc_name, treat_contents, chart_contents, treat_datetime
from Charts a 
join Patients b
on a.pat_id = b.pat_id
